...
export const theme: ThemeUserConfig = {
  ...
  title: "Yandick's blog",
  /** Will be used in index page & copyright declaration */
  author: 'Yandick',
  author_en: 'Yandick',
  /** Description metadata for your website. Can be used in page metadata. */
  description: 'Yandick\'s blog',
  description_en: 'Yandick\'s blog',
  ...
  footer: {
    ...
    social: { github: 'https://github.com/Yandick' }
  },
  ...
  personal: {
    ...
    githubUsername: 'Yandick',
    /** Your email address */
    email: 'Kent1279313179@gmail.com',
    ...
    blogStartDate: '2026-03-21',
    /** Domain configuration */
    domains: {
      main: 'yandick.github.io',
      githubPages: 'yandick.github.io',
      // cloudflare: '',
      // friendCircle: '',
    },
  }
...
export const integ: IntegrationUserConfig = {
  links: {
    ...
    applyTip: [
      ...
      { name: 'Link', val: `https://${theme.personal?.domains?.githubPages || theme.personal?.domains?.main || 'example.github.io'}` },
      { name: 'Avatar', val: `https://${theme.personal?.domains?.githubPages || theme.personal?.domains?.main || 'example.github.io'}/avatar/avatar.png` }
